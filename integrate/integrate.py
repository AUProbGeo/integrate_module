...
# ---------------------------------------------------------------------------
# Posterior statistics — delegated to integrate.integrate_posterior
# ---------------------------------------------------------------------------
# The full implementation (stat registry, batched NumPy driver, JAX backend)
# lives in integrate/integrate_posterior.py.  This wrapper preserves the
# original API so that "ig.integrate_posterior_stats(...)" continues to
# work, and also re-exports the internal helpers for backwards compatibility
# with code that imports them directly from integrate.integrate.

from integrate.integrate_posterior import integrate_posterior_stats
from integrate.integrate_posterior import _register_continuous, _register_discrete
from integrate.integrate_posterior import _CONTINUOUS_STATS, _DISCRETE_STATS
from integrate.integrate_posterior import _JAX_CONTINUOUS_STATS, _JAX_DISCRETE_STATS
from integrate.integrate_posterior import _JAX_POSTSTATS_AVAILABLE
from integrate.integrate_posterior import _ps_mean, _ps_logmean, _ps_std, _ps_logstd
from integrate.integrate_posterior import _ps_median, _ps_harmonic_mean, _ps_kl_continuous
from integrate.integrate_posterior import _ps_class_counts, _ps_mode, _ps_entropy
from integrate.integrate_posterior import _ps_prob, _ps_kl_discrete
from integrate.integrate_posterior import _ps_is_continuous, _ps_is_discrete
from integrate.integrate_posterior import _ps_compute_n_unique
from integrate.integrate_posterior import _ps_prior_hist_continuous, _ps_prior_hist_discrete
from integrate.integrate_posterior import _ps_process_continuous, _ps_process_discrete
from integrate.integrate_posterior import _ps_jax_process_continuous, _ps_jax_process_discrete
from integrate.integrate_posterior import _ps_numpy_fallback_continuous_kl
from integrate.integrate_posterior import _ps_integrate_posterior_stats_jax
